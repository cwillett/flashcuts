			...
			<div class="box-body">
				<table class="wp-list-table widefat striped system" cellspacing="0">
					...
					if ( function_exists( 'fsockopen' ) || function_exists( 'curl_init' ) ) {
						...
						$checks['fsockopen_curl']['note']    = __( 'Your server does not have fsockopen or cURL enabled. Contact your hosting provider.', 'insight-core' ) . '</mark>';
					}
					// DOMDocument
					...
					if ( class_exists( 'DOMDocument' ) ) {
						...
						$checks['dom_document']['note']    = sprintf( __( 'Your server does not have the <a href="%s">DOMDocument</a> class enabled. Contact your hosting provider.', 'insight-core' ), 'http://php.net/manual/en/class.domdocument.php' ) . '</mark>';
					}
					// WP Remote Get Check
					...
					if ( ! is_wp_error( $response ) && $response['response']['code'] >= 200 && $response['response']['code'] < 300 ) {
						...
						$checks['wp_remote_get']['note'] = __( ' WordPress function <a href="https://codex.wordpress.org/Function_Reference/wp_remote_get">wp_remote_get()</a> test failed. Contact your hosting provider.', 'insight-core' );
