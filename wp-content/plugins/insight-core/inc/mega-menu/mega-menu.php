	...
	class Insight_Mega_Menu {
		...
		function insight_core_register_megamenu() {
			...
			$labels = array(
				...
				'menu_name'          => __( 'Mega Menu', 'insight-core' ),
				'name_admin_bar'     => __( 'Mega Menu', 'insight-core' ),
				'parent_item_colon'  => __( 'Parent Menu:', 'insight-core' ),
				'all_items'          => __( 'All Menus', 'insight-core' ),
				'add_new_item'       => __( 'Add New Menu', 'insight-core' ),
				'add_new'            => __( 'Add New', 'insight-core' ),
				'new_item'           => __( 'New Menu', 'insight-core' ),
				'edit_item'          => __( 'Edit Menu', 'insight-core' ),
				'update_item'        => __( 'Update Menu', 'insight-core' ),
				'view_item'          => __( 'View Menu', 'insight-core' ),
				'search_items'       => __( 'Search Menu', 'insight-core' ),
				'not_found'          => __( 'Not found', 'insight-core' ),
				'not_found_in_trash' => __( 'Not found in Trash', 'insight-core' ),
			);

			$args = array(
				'label'               => __( INSIGHT_MEGA_MENU_POST_TYPE, 'insight-core' ),
				'description'         => __( 'Insight Mega Menu', 'insight-core' ),
				'labels'              => $labels,
				'supports'            => array(
					'title',
					'editor',
