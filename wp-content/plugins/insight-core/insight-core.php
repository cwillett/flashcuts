...
define( 'INSIGHT_CORE_INC_DIR', dirname( __FILE__ ) );
...
if ( ! class_exists( 'InsightCore' ) ) {
	...
	class InsightCore {
		...
		function __construct() {
			...
			// Custom Functions
			include_once( INSIGHT_CORE_INC_DIR . '/inc/custom_functions.php' );

			// Register Posttypes
			include_once( INSIGHT_CORE_INC_DIR . '/inc/register-posttypes.php' );

			// Pages
			include_once( INSIGHT_CORE_INC_DIR . '/inc/pages.php' );

			// TMG
			include_once( INSIGHT_CORE_INC_DIR . '/inc/tgm-plugin-activation.php' );
			require_once( INSIGHT_CORE_INC_DIR . '/inc/tgm-plugin-registration.php' );

			// Import & Export
			include_once( INSIGHT_CORE_INC_DIR . '/inc/export/export.php' );
			include_once( INSIGHT_CORE_INC_DIR . '/inc/import/import.php' );

			// Kirki
			include_once( INSIGHT_CORE_INC_DIR . '/libs/kirki/kirki.php' );
			add_filter( 'kirki/config', array( $this, 'kirki_update_url' ) );

			// Update
			include_once( INSIGHT_CORE_INC_DIR . '/inc/update/class-updater.php' );

			// Others
			include_once( INSIGHT_CORE_INC_DIR . '/inc/customizer/io.php' );
			include_once( INSIGHT_CORE_INC_DIR . '/inc/notices.php' );
			include_once( INSIGHT_CORE_INC_DIR . '/inc/breadcrumb.php' );
			include_once( INSIGHT_CORE_INC_DIR . '/inc/better-menu-widget.php' );
			include_once( INSIGHT_CORE_INC_DIR . '/libs/mobile-detect/mobble.php' );
		...
		public function after_setup_theme() {
			...
			// CMB2
			require_if_theme_supports( 'insight-cmb2', INSIGHT_CORE_INC_DIR . '/libs/cmb2/init.php' );
			add_filter( 'cmb2_meta_box_url', array( $this, 'cmb2_meta_box_url' ) );

			// Kungfu Framework
			require_if_theme_supports( 'insight-kungfu', INSIGHT_CORE_INC_DIR . '/libs/kungfu/kungfu-framework.php' );

			// Mega menu
			require_if_theme_supports( 'insight-megamenu', INSIGHT_CORE_INC_DIR . '/inc/mega-menu/mega-menu.php' );

			// Popup
			require_if_theme_supports( 'insight-popup', INSIGHT_CORE_INC_DIR . '/inc/popup/popup.php' );

			// Attribute Swatches
			require_if_theme_supports( 'insight-swatches', INSIGHT_CORE_INC_DIR . '/inc/swatches/swatches.php' );
		}
		...
		public function ajax_get_changelogs() {
			...
			self::get_info();
			require_once( INSIGHT_CORE_INC_DIR . '/inc/update/changelogs.php' );
			die;
		}
		...
		public static function check_valid_update() {
			...
			if ( $purchase_info = get_option( 'insight_core_purchase_info' ) ) {
