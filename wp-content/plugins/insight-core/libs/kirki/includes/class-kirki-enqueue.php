...
if ( ! class_exists( 'Kirki_Enqueue' ) ) {
	...
	class Kirki_Enqueue {
		...
		public function customize_controls_enqueue_scripts() {
			...
			wp_enqueue_script( 'kirki-tooltip', trailingslashit( Kirki::$url ) . 'assets/js/tooltip.js', array(
				'jquery',
				'customize-controls',
				'jquery-ui-tooltip'
			) );
			...
			wp_enqueue_script( 'kirki-reset', trailingslashit( Kirki::$url ) . 'assets/js/reset.js', array(
				'jquery',
			...
			wp_register_script( 'kirki-notifications', trailingslashit( Kirki::$url ) . 'assets/js/functions/notifications.js', array(
				'kirki-l10n',
			...
			wp_register_script( 'jquery-ui-spinner', trailingslashit( Kirki::$url ) . 'assets/js/vendor/jquery-ui-spinner', array(
				'jquery',
				'jquery-ui-core',
				'jquery-ui-button'
			) );
