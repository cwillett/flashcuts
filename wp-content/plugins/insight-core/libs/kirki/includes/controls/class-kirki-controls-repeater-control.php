...
if ( ! class_exists( 'Kirki_Controls_Repeater_Control' ) ) {
	...
	class Kirki_Controls_Repeater_Control extends Kirki_Customize_Control {
		...
		protected function render_content() {
			?>
			<?php if ( '' !== $this->tooltip ) : ?>
				<a href="#" class="tooltip hint--left" data-hint="<?php echo esc_html( $this->tooltip ); ?>"><span
						...
						<li class="repeater-row minimized" data-row="{{{ index }}}">
							...
							<div class="repeater-row-content">
								<# _.each( data, function( field, i ) { #>
																		...
																		<# if ( field.label ) { #>
																			...
																			<# } #>
																				<# if ( field.description ) { #>
																					...
																					<# } #>
																						<div
																							class="customize-control-content repeater-dropdown-pages">
																							{{{ field.dropdown }}}
																						</div>
																	</label>
																									...
																									<# } #>
																										...
																										<# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
																											...
																											<figure
																												...
																												data-placeholder="<?php echo esc_attr( $this->l10n['no-image-selected'] ); ?>">
																												<# if ( field.default ) { #>
																											...
																											<div
																												...
																												<button
																													type="button"
																													class="button remove-button<# if ( ! field.default ) { #> hidden<# } #>"><?php echo esc_attr( $this->l10n['remove'] ); ?></button>
																												<button
																													type="button"
																													class="button upload-button"
																													data-label=" <?php echo esc_attr( $this->l10n['add-image'] ); ?>"
																													data-alt-label="<?php echo esc_attr( $this->l10n['change-image'] ); ?>">
																													<# if ( field.default ) { #>
																											...
																											<# } else if ( field.type === 'upload' ) { #>
																												...
																												<figure
																													class="kirki-file-attachment"
																													data-placeholder="<?php echo esc_attr( $this->l10n['no-file-selected'] ); ?>">
																													<# if ( field.default ) { #>
																														<# var defaultFilename = ( field.default.filename ) ? field.default.filename : field.default; #>
																															<span
																																class="file"><span
																																	class="dashicons dashicons-media-default"></span> {{ defaultFilename }}</span>
																															<# } else { #>
																												...
																												<div
																													...
																													<button
																														type="button"
																														class="button upload-button"
																														data-label="<?php echo esc_attr( $this->l10n['add-file'] ); ?>"
																														data-alt-label="<?php echo esc_attr( $this->l10n['change-file'] ); ?>">
																														<# if ( field.default ) { #>
									...
									<# }); #>
										<button type="button"
										        class="button-link repeater-row-remove"><?php echo esc_attr( $this->l10n['remove'] ); ?></button>
							</div>
						</li>
			</script>
			<?php
