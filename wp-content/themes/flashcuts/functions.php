...
function custom_oembed_filter($html, $url, $attr, $post_ID) {
    $embed_return = '<div class="video">'.$html.'</div>';
    return $embed_return;}
...
/* Add menu pages */
    ...
    function register_contact_menu_page(){
        add_menu_page( 'Contact', 'Contact', 'manage_options', 'contact-menu-page', 'contact_menu_page', '', 58 ); 
    }

    function contact_menu_page(){
        echo '<script type="text/javascript"> window.location = "/wp-admin/post.php?post=79&action=edit" </script>';
    }